...
żeby efektywnie wyszukiwać zarówno treść konkretnej tabliczki jak i tabliczki, których treść spełnia kryteria
...
% TODO: co to znaczy ``możliwość odwzorowania treści tabliczki między reprezentacjami''?
% napisać więcej na temat dlaczego jest tak zanim dojdziemy do tego jak jest
% Jeśli szukamy tabliczki zawierającej jakieś slowa używamy tabelki Reading wpp - tabelki Tablet
