...
Moduł \textbf{Translator\_postgres} tłumaczy otrzymane fragmenty drzewa struktury zapytania na język SQL. Przetłumaczone fragmenty zbiera do buforów 
...
Moduł \textbf{Database\_postgres} odpowiada za wywołanie zapytania w konkretnej bazie i zapisanie wyniku do struktury Tablets.
