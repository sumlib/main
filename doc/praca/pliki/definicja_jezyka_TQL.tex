...
\chapter{\label{chap:skladnia}Gramatyka}
...
% TODO: warto zauważyć, że search in to tak naprawdę zapytanie proste
\subsection{Zwykłe}
\begin{verbatim}
...
Takie zapytanie jest równoważne zapytaniu prostemu - wnętrzu zapytania zdefiniowanego.
...
\end{itemize}
Łatwo zauważyć, że jest to część wspólna zbiorów wyników dwóch zapytań prostych. Jedno z nich to wnętrze zapytania zdefiniowanego, a drugie to dodatkowe warunki wyszukiwania.
