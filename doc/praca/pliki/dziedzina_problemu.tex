...
Powstało jako pomoc w sprawach gospodarczych (np. ilość i rodzaj obiecanych ludziom zwierząt). 
...
na podstawie prawdopodobnego brzmienia słów po sumeryjsku. 
...
alternatywnych tłumaczeń (wymaga to przetłumaczenia tabliczki spowrotem na oryginalne kliny) oraz metadanych.
