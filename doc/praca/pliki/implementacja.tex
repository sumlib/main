...
i wywołujące je.
\end{enumerate}
 Wybór modułu wymiennego odbywa się na poziomie kompilacji. Prototypowa implementacja zawiera 2 moduły wymienne:
  \begin{itemize}
   \item dla bazy PostgreSQL
   \item dla bazy XML
  \end{itemize}
  Makefile domyślnie buduje obie implementacje tql-a.
