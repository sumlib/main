...
%TODO tu mi brakuje jakiego wyjaśnienia co to znaczy albo jakie ma skutki, że to jest na poziomie kompilacji.
% skutki: jeden skompilowany translator jest dla jednego typu bazy danych - jest z jednej strony lżejszy z drugiej mniej 
% uniwersalny. Jak chcemy inny - musimy przekompilwać. Krzysiek mówi, że jedyną zaletą jest to, że to jest prostsze
...
% nom, można by. tylko jakoś krótko (-;
Parser został utworzony za pomocą narzędzia BNFC \cite{bnfc}. Następnie 
...
oraz ogólnie uporządkowałyśmy kod.
...
% TODO: może wcześniej warto zauważyć (przy semantyce języka), że search in to tak naprawdę zapytanie proste
