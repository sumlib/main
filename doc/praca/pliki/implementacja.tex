...
drzewo struktury składniowej zapytania TQL. Funkcja:
\begin{itemize}
 \item sprawdza, czy podano prawidłowe nazwy pól, na podstawie których następuje wyszkukiwanie,  %to co jest po lewej w linii zapytania jest nazwą pola.
