...
ogólnego zastosowania, np. SQL, XQuery, odpowiednio do sposobu reprezentacji danych.
% TODO: bibliografia

Sposobem reprezentacji danych nazywamy rodzaj bazy danych (np. relacyjna, obiektowa, XML), konkretną implementację serwera 
(np. PostgreSQL, Zorba) oraz schemat danych. Dla każdego takiego sposobu zapytanie w docelowym jzyku może się różnić, a zatem 
