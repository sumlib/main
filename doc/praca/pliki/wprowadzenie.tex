...
Opisywanie problemów jest wtedy znacznie prostsze i bardziej naturalne, a dzięki temu wygodne dla ludzi związanych tylko z 
konkretną dziedziną. 
...
lub na stworzeniu od podstaw innego niż istniejące do tej pory (wzorzec "Language invention" \cite{mernik}).
...
TQL może być także podstawą do tworzenia podobnych języków wyszukiwania dostosowanych do potrzeb innych grup ludzi, np. językoznawców.
