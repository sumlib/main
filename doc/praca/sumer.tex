...
% Słowa kluczowe:
\keywords{tabliczka, sumerologia, kliny, odczyty, język dziedzinowy}
...
\bibitem{cexplode} \url{http://maz-programmersdiary.blogspot.com/2008/09/c-explode.html}
\bibitem{cdli} \url{http://cdli.ucla.edu}
\bibitem{etcsl} \url{http://etcsl.orinst.ox.ac.uk/}
